...
def get_sales_data():
    ...
    via the terminal, which must be a striing of 6 numbers separated
...
def update_worksheet(data, worksheet):
    ...
    print(f'{worksheet} worksheet updated succfully\n')
...
print("Welcome to Love Sandwiches Data Automstion")
main()
